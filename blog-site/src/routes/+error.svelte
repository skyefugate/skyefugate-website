...
<svelte:head>
  ...
  <meta name="description" content="Page not found. The requested page doesn't exist on {config.author}'s blog." />
</svelte:head>
...
{#if status === 404}
  <div class="suggestions">
    ...
    <div class="suggestion-links">
      ...
      <LinkButton to="/archive">Archive</LinkButton>
      <LinkButton to="/categories">Categories</LinkButton>
